 ...
 *         the card ranks are consecutive numbers. The number of required cards
 *         is equal to the hand size. An ace (card of rank 1) may be treated as
 *         the highest possible card or as the lowest (not both). To evaluate a
